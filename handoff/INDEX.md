...
| TASK-0088 | open | v0.16.1 | 040 | ops | 🔴 Прод-диагностика — email-intel/deep/поддомены не работают (worker: образ или egress) | — (диагностика на прод-машине; в git идёт только отчёт) |

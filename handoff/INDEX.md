...
|----|--------|-----------|-----|---------|------|-------|
| TASK-0050 | open | v0.14.0 | 041 | code | FSM MemoryStorage → RedisStorage (ADR 041) | — |
...
| TASK-0049 | in_review | v0.14.0 | — | code | html.escape во всех change-нотификациях (defense-in-depth) | task/0049-htmlescape-all-notifications |

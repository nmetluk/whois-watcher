...
| TASK-0037 | open | v0.12.0 | 038 | code | Hardening поддоменов — html.escape в нотификациях + кап интервала FSM (ADR 038) | — |
| TASK-0035 | in_review | v0.12.0 | 038 | code | Fan-out поддоменов — устранить N+1 и ordering-зависимый дедуп toggle'ов (ADR 038) | task/0035-subdomain-fanout-nplus1-toggle-dedup |

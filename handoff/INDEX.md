...
|----|--------|-----------|-----|---------|------|-------|
| TASK-0034 | open | v0.12.0 | 038 | code | Тесты success+diff→enqueue и baseline в check_subdomains (ADR 038) | — |
...
| TASK-0033 | in_review | v0.12.0 | 038 | code | Реальные тесты fan-out notify_subdomain_changes (ADR 038) | task/0033-notify-subdomain-fanout-tests |

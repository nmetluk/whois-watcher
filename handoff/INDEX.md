...
| TASK-0031 | open | v0.11.1 | 039 | code | Схема — отдельная таблица wishlist + миграция переноса (ADR 039) | — |
| TASK-0032 | open | v0.11.1 | 039 | code | Развязка wishlist↔tracking по коду + кнопка «убрать из wishlist» (ADR 039) | — |

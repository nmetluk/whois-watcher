...
**Следующий шаг:** **TASK-0036 «Релиз v0.12.0»** — PR #27 открыт.
После мержа архитектором: аннотированный тег `v0.12.0` + `scripts/deploy.sh`.
v0.11.1 в прод уже должен быть выкачен ранее.

(Релиз будет отмечен в STATE после мержа + тега.)

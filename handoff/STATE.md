...
**Обновлено:** 2026-05-30 (релиз v0.10.0 — email-intel) · **Релиз на main:** v0.10.0 · **Последний ADR:** 036
...
| Subdomain enumeration (CT-логи/crt.sh) | v0.11 | 037 | план (вынесено из 036) — следующий дизайн |
...
✅ **Релиз v0.10.0 выпущен** (тег `v0.10.0` → `b081c9a`): подсистема email-intel
(MX/SPF/DKIM/DMARC, ADR 036) + instance-тег. На main pyproject = 0.10.0.

**Следующий шаг — дизайн ADR 037** (subdomain enumeration через CT-логи/crt.sh,
v0.11): архитекторская задача в отдельной сессии. Открытых исполнительских
тасков нет.

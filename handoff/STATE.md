...
**Обновлено:** 2026-06-11 (✅ РЕЛИЗ v0.16.0 — Telegram WebApp; вся цепочка ADR 043 закрыта (0066–0074, аудит 0071, фиксы 0081–0084)) · **Релиз на main:** v0.16.0 · **Последний ADR:** 043
...
**Следующий шаг:** **деплой v0.16.0** — образ + статика webapp через nginx
(+ CSP, `WEBAPP_ORIGIN`, `WEBAPP_INITDATA_TTL`), регистрация mini-app в BotFather;
⚠️ перед деплоем — ручной бекап БД (новая миграция `20260610_domain_group`).
v0.15.2 уже задеплоен. Дальше — **v1.0** (web-дашборд вне Telegram, публичный
API, орг-аккаунты, Prometheus).

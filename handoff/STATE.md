...
**Обновлено:** 2026-06-11 (✅ 0081/0082/0083 (F1–F7 аудита 0071) реализованы исполнителем, in_review; 0071→FIX-THEN-GO закрыт) · **Релиз на main:** v0.15.2 · **Последний ADR:** 043
...
**Следующий шаг:** 0081/0082/0083 взяты исполнителем и реализованы (ветки task/0081..., in_review, сессии 2026-06-11). После ревью/мержа → **0072** (релиз v0.16) или 0084 (мелочи) + 0065. Деплой v0.15.2 (DNS) + webapp. Дальше — v1.0 (web-дашборд, публичный API, орг-аккаунты, Prometheus).

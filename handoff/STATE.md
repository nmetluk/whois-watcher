...
**Обновлено:** 2026-06-09 (✅ хотфикс v0.15.1 + архитекторский follow-up: локализация доставки 0076, откат рискованного nameservers-хардкода 0077; тег перенесён на чистый main) · **Релиз на main:** v0.15.1 · **Последний ADR:** 043
...
**Следующий шаг:** деплой v0.15.1; затем webapp-цепочка (0073 группы → 0071
security-аудит, включает нити из 0074 → 0072 релиз v0.16) + опц. TASK-0065.
Дальше — v1.0 (web-дашборд, публичный API, орг-аккаунты, Prometheus).

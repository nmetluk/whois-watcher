...
**Обновлено:** 2026-06-04 (v0.13.0 выпущен; v0.13-cleanup 0048 влит; спроектирован v0.14 — стабилизация/тех-долг, ADR 041 FSM→Redis, таски 0049–0055) · **Релиз на main:** v0.13.0 · **Последний ADR:** 041
...
**Следующий шаг:** **деплой v0.13.0** (`bash scripts/deploy.sh`) после зелёного
CI; затем отдать исполнителю первый таск v0.14 (можно начинать с **0049** или
**0050** — независимы). Дальше после v0.14 — крупные фичи v1.0 (web-дашборд,

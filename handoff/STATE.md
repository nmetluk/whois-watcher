...
**Обновлено:** 2026-06-07 (✅ TASK-0092: «свободен» только после RDAP-верификации (ADR 045) — закрыт инцидент discozavr.ru из 0091; «сбой ≠ свободен» guard; UX «подтвердить не удалось». Открыт TASK-0093 (инфра): relay/VDS stale «No entries» + короткий TTL негативных ответов. Прод ждёт редеплоя 0087-0092; webapp этап 2 «Ещё»-экранов — впереди) · **Релиз на main:** v0.16.0 + hotfix'ы + 0085-0092 (прод ждёт редеплоя) · **Последний ADR:** 045

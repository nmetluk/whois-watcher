...
(2026-05-31) **все** фиксы аудита влиты в v0.12.0, а не вынесены в v0.12.1.
Осталось закрыть 🟡 **TASK-0035** (N+1 + ordering-зависимый дедуп toggle'ов)
и 🟢 **TASK-0037** (html.escape в нотификациях + верхний кап интервала FSM) →
затем **TASK-0036** «Релиз v0.12.0» (`depends_on: 0033/0034/0035/0037`: bump
`pyproject` 0.11.1→0.12.0, секция CHANGELOG `[0.12.0]`, тег, деплой).
0033/0034 ✅ смержены. Деплой v0.11.1 в прод, если ещё не катился.

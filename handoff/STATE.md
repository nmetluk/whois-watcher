...
**Следующий шаг:** **TASK-0063 «Релиз v0.15.0»** (bump 0.14.0→0.15.0, CHANGELOG,
тег). ⚠️ Деплой v0.15: **пересобрать образ** (`postgresql-client-16`) + создать
том `ww_backups` + выставить BACKUP_*/AUDIT_RETENTION_DAYS. Деплой v0.14.0
тоже ещё опц. ждёт. После v0.15 — **WebApp (ADR 043, TASK-0064)**. Дальше — v1.0
(web-дашборд,

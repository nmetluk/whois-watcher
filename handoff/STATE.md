...
**Обновлено:** 2026-05-31 (v0.12.0 выпущен и задеплоен; спроектирован v0.13 — deep email + on-demand views, ADR 040, таски 0038–0044) · **Релиз на main:** v0.12.0 · **Последний ADR:** 040
...
**Следующий шаг:** отдать **TASK-0038** исполнителю (готов к `claim`).
Дальше по roadmap (после v0.13) — **v1.0** (web-дашборд, публичный API,
орг-аккаунты, Prometheus) + tech-debt (html.escape в остальных нотификациях,
FSM→RedisStorage).

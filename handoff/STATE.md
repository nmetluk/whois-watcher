...
**Следующий шаг:** **TASK-0036 «Релиз v0.12.0»** разблокирован
(`depends_on: 0033/0034/0035/0037` — все done): bump `pyproject`
0.11.1→0.12.0, секция CHANGELOG `[0.12.0]` (сейчас `[Unreleased]` пуста),
аннотированный тег, деплой. Деплой v0.11.1 в прод, если ещё не катился.

...
**Следующий шаг:** закрыть 🟠 **TASK-0047** → **TASK-0044** «Релиз v0.13.0»
(`depends_on: 0043/0047`; bump 0.12.0→0.13.0, CHANGELOG, тег, деплой).
Дальше по roadmap — **v1.0** (web-дашборд, публичный API, орг-аккаунты,
Prometheus) + tech-debt.

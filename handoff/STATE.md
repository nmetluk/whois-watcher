...
| Поддомены / PSL / DNS-SSL у поддомена | v0.9.0 | 035 ✅ | TASK-0002, 0003, 0004 done (merged); 0005 open + аудит 0006 |
...
TASK-0002 (PSL), 0003 (миграция+джойны), 0004 (WHOIS-роутинг по
registrable) смержены в main. Следующий — **`TASK-0005`** (UX `/whois`,
`/add`, `/list`, локали + заполнение `registrable_domain`/`is_subdomain`
при вставке), затем `TASK-0006` (аудит) и релиз v0.9.0.

...
**Обновлено:** 2026-06-11 (✅ 0081/0082/0083 смержены архитектором — все блокеры аудита 0071 (F1–F7) закрыты; v0.16 готов к релизу 0072) · **Релиз на main:** v0.15.2 · **Последний ADR:** 043
...
**Следующий шаг:** деплой v0.15.2 (+ при необходимости `DNS_NAMESERVERS`);
**0072** (релиз v0.16) — все депенденси (0071/0081/0082/0083) закрыты;
параллельно 0084 (🟢 ниты, fast-follow). Дальше — v1.0 (web-дашборд, публичный

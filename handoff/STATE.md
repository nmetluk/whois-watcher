...
**Обновлено:** 2026-06-07 (✅ TASK-0091: прод-диагностика «свободен» для зарегистрированного discozavr.ru — root cause в TCI relay + broad _looks_like_not_found в парсере; собран raw proxy + подтверждён парсинг; без код-фиксов, гипотеза подтверждена → ждёт TASK-0092. Ранее: 0090 DNS-отчёт, 0089 TXT-fix). Прод ждёт редеплоя 0087/0089/0090; webapp этап 2 «Ещё»-экранов — впереди) · **Релиз на main:** v0.16.0 + hotfix'ы + 0085-0090 (прод ждёт редеплоя) · **Последний ADR:** 044

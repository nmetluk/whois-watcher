...
**Обновлено:** 2026-05-31 (v0.12.0 выпущен и **задеплоен в прод**; tag `v0.12.0`, GitHub Release опубликован; роадмап TODO.md освежён) · **Релиз на main:** v0.12.0 · **Последний ADR:** 039
...
**Следующий шаг:** доска задач (`handoff/INDEX.md`) пуста — точка выбора
нового крупного этапа. Дорожная карта subdomain + domain-intelligence
(ADR 035–039) полностью закрыта. `TODO.md` освежён: впереди **v1.0**
(web-дашборд, публичный read-only API, орг-аккаунты, Prometheus, расширение
ccTLD-парсеров) + tech-debt (html.escape в остальных нотификациях,
FSM→RedisStorage, интеграционные ARQ-тесты на Postgres+Redis).

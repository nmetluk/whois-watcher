...
**Следующий шаг:** **TASK-0055 «Релиз v0.14.0»** (bump 0.13.0→0.14.0, CHANGELOG
`[0.14.0]`, тег, деплой) — после зелёного CI. Деплой v0.13.0 в прод тоже ещё
ждёт. Дальше после v0.14 — крупные фичи v1.0 (web-дашборд,

...
**Обновлено:** 2026-06-05 (✅ TASK-0089: КОРЕНЬ инцидента MX/deep найден и закрыт — несуществующий TXT.to_unicode() в email-слое (7 мест), выявлен last_error'ом из прод-отчёта TASK-0088; гипотезы «образ/egress» опровергнуты диагностикой. Также: TASK-0087 этап 1 (карточка домена/календарь/дашборд). Нужен редеплой 0087+0089; этап 2 «Ещё»-экранов — впереди) · **Релиз на main:** v0.16.0 + hotfix'ы + 0085-0089 (прод ждёт редеплоя 0087/0089) · **Последний ADR:** 043

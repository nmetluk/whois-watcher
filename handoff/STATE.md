...
**Обновлено:** 2026-06-09 (✅ хотфикс-релиз v0.15.1: TASK-0075/0076/0077/0078 смержены и выпущены — доставка on-demand/карточки + глубокий e-mail) · **Релиз на main:** v0.15.1 · **Последний ADR:** 043
...
✅ **ХОТФИКС v0.15.1 выпущен** (2026-06-09, TASK-0078, архитектором): bump 0.15.0→0.15.1, CHANGELOG `[0.15.1]`, тег `v0.15.1`. Смержены 0075 (досыл on-demand кнопок), 0076 (доставка MX/SSL/DNS в карточке), 0077 (фикс пустого deep-email + интеграц-тест + публичные DNS). Прод-баги #1–#4 закрыты.

**Следующий шаг:** возврат к webapp-консолидации (TASK-0074 в in_review) + опц. TASK-0065; затем webapp-цепочка (0073 группы → 0071 security-аудит → 0072 релиз v0.16). Дальше — v1.0 (web-дашборд, публичный API, орг-аккаунты, Prometheus).

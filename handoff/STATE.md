...
**Обновлено:** 2026-06-05 (✅ TASK-0086: on-demand задачи при фейле шлют пользователю ошибку, не молчат. Инцидент «поддомены/MX/deep» — код идентичен v0.15.2, корень на проде: чек-лист для админа в docs/sessions/2026-06-05_diagnosis-ondemand-email-prod.md. Готово к редеплою: hotfix 500 + кнопка 0085 + 0086 одним заходом; после — дропнуть stash на прод-машине) · **Релиз на main:** v0.16.0 + hotfix'ы + 0085 + 0086 (прод ждёт редеплоя) · **Последний ADR:** 043

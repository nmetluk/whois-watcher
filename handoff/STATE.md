...
**Обновлено:** 2026-06-05 (✅ TASK-0090: DNS-отчёт — кнопка «🧾 DNS-отчёт» в /whois, расширенный анализ всех записей файлом (ADR 044, новая подсистема src/dns_report). Ранее: 0089 (корень MX/deep), 0087 этап 1 (webapp). Прод ждёт редеплоя 0087/0089/0090; webapp этап 2 «Ещё»-экранов — впереди) · **Релиз на main:** v0.16.0 + hotfix'ы + 0085-0090 (прод ждёт редеплоя) · **Последний ADR:** 044

...
**Обновлено:** 2026-05-30 (релиз v0.9.3; email-intel готов на main) · **Релиз на main:** v0.9.2 (+ unreleased email-intel/instance-тег) · **Последний ADR:** 036
...
| Email/policy-записи (MX/SPF/DKIM/DMARC) | v0.10 | 036 ✅ | **код done (TASK-0015…0018) на main; готов к тегу v0.10.0** |
| Instance-тег в админ-алертах | v0.9.3 | 019 | **релиз v0.9.3 выпущен** (hotfix-ветка от v0.9.2, TASK-0019) |
...
**Следующий релиз — v0.10.0** (email-intel): нужен релиз-таск — bump
pyproject/uv.lock `0.9.2`→`0.10.0`, секция CHANGELOG `[0.10.0]` (вся подсистема
email-intel + instance-тег уже на main), тег `v0.10.0` на main. Открытых
исполнительских тасков нет (кроме forward-дизайна v0.11 — ADR 037 enumeration).

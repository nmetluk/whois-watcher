...
**Следующий шаг:** **TASK-0036 «Релиз v0.12.0»** в работе (PR готовится):
bump `pyproject` 0.11.1→0.12.0 + секция CHANGELOG `[0.12.0]`. После мержа —
аннотированный тег `v0.12.0` и деплой (`scripts/deploy.sh`). v0.11.1 в прод
уже должен быть выкачен ранее.

✅ **Релиз v0.12.0 выпущен** (тег `v0.12.0` → TBD): мониторинг поддоменов
(ADR 038) + все hardening-фиксы аудита (0033–0037). Подробности в
`handoff/tasks/TASK-0036-release-v0-12-0.md` и сессии.

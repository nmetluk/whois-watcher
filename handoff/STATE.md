...
**Обновлено:** 2026-06-03 (релиз v0.13.0 выпущен: deep email + on-demand views (ADR 040) + MTA-STS hardening TASK-0047; все блокеры закрыты) · **Релиз на main:** v0.13.0 · **Последний ADR:** 040

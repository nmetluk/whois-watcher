...
LOCALE: dict[str, str] = {
    ...
    "deep_email.tls_rpt_present": "запись присутствует",
    "deep_email.tls_rpt_rua": "rua: {rua}",
    "deep_email.tls_rpt_none": "нет записи",
    "deep_email.section_dane": "DANE / TLSA (по MX)",
    "deep_email.dane_none": "нет данных",
    "deep_email.section_bimi": "BIMI",
    "deep_email.bimi_present": "присутствует",
    "deep_email.bimi_none": "нет записи",
    "deep_email.fetched_at": "собрано: {date}",
    ...
    "commands.whois.email_spf_mode.fail": "строгий",
    "commands.whois.email_spf_mode.softfail": "мягкий",
    "commands.whois.email_spf_mode.neutral": "нейтральный (?all)",
    "commands.whois.email_spf_mode.pass": "разрешить всё (+all) ⚠️",
    "commands.whois.email_spf_mode.none": "нет записи",
    "commands.whois.email_line_dmarc": "DMARC: {policy}",
    "commands.whois.email_no_dmarc": "DMARC: не настроен",
    "commands.whois.email_dmarc_none_compact": "нет",
    "commands.whois.email_dmarc_policy.none": "нет",
    ...
    # TASK-0092: «свободен» по WHOIS, но RDAP-подтверждение получить не удалось
    "commands.whois.free_unverified": (
        "🌐 {domain} — записи в WHOIS не найдено\n\n"
        "Похоже, домен свободен, но подтвердить это по второму источнику "
        "(RDAP) не удалось. Если домен зарегистрирован недавно — данные "
        "реестра могли ещё не обновиться. Проверьте позже: /check {domain}"
    ),
    # ------------------------------------------------------------------
    # /list — строка
    # ------------------------------------------------------------------
